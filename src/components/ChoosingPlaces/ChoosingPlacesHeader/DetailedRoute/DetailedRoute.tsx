...
export const DetailedRoute = () => {
  ...
  return (
    <div style={ { display: "flex", gap: "30px", flexDirection: "row" } }>
      ...
      <div>
        <div>{ coach.name }</div>
        <div>{ routeData.departure.from.city.name } →</div>
        <div>{ routeData.departure.to.city.name }</div>
      </div>
      <div>
        <div>
        ...
        <div>{ routeData.departure.from.city.name }</div>
        <div>{ routeData.departure.from.railway_station_name }</div>
      </div>
      <div>
        <svg
          width="30"
      ...
      <div>
        <div>{ formatedTime( routeData.departure.to.datetime ) }</div>
        <div>{ routeData.departure.to.city.name }</div>
        <div>{ routeData.departure.to.railway_station_name }</div>
      </div>
      <div>
        { calculateTravelTime(
