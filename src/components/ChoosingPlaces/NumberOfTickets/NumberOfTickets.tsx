...
export const NumberOfTickets = () => {
  const { allSeats } = useSelector((state: RootState) => state.selectedSlice);
    ...
    <>
      ...
      <div className={styles.wrapper_number_of_tickets}>
        ...
        <div className={styles.number_of_tickets_item}>
          ...
          <p className={styles.placeholder}>Детских — {Math.floor(allSeats !== null ? allSeats / 2 : 0)} </p>
          <div className={styles.description}>Можно добавить еще {Math.floor(allSeats !== null ? allSeats / 2 : 0)} детей до 10 лет.Свое
